  ...
  return <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl">
          ...
          animationDelay: '0.4s'
        }}>From our state-of-the-art facilities in Ankleshwar, Gujarat and Dahej, Gujarat, we manufacture and deliver speciality and bulk chemicals with unwavering quality and reliability.</p>
