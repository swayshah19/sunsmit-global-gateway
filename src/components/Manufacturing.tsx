...
const Manufacturing = () => {
  ...
  const labEquipment = [
    "HPLC", "GC", "FTIR", "Karl Fischer", "Wet-analysis facilities"
  ];

  const qualityFeatures = [
    "In-process inspection at every production stage",
    "Batch-level traceability with documented COAs",
    "Advanced testing facilities for purity and consistency",
    "Compliance with domestic and international standards"
  ];

  const customServices = [
    "Raw material selection and optimization",
    "Application and process compatibility testing", 
    "Regulatory and technical documentation support"
  ];

  const facilityFeatures = [
    "Custom chemical blending & packaging services",
    "Just-in-time stocking for fast dispatch",
    "100,000+ sq.ft. of production & storage capacity"
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Infrastructure – The Backbone of SunSmit Dye Chem
          </h2>
