  ...
  return <section id="about" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-left md:text-center">Established in 1996, SunSmit Dyechem Pvt. Ltd. is a trusted manufacturer of Sodium HypoChlorite in India and a leading supplier of Specialty Chemicals,Inorganic Chemicals, Organic Chemicals, Dyes & Dye Intermediates, Agro-Chemicals and Intermediates, Active Pharmaceutical Intermediates,and Custom Chemical Formulations from Gujarat, backed by over three decades of expertise,with a strong presence across domestic markets and international regions including Africa, Europe, and Asia.</p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-muted-foreground">
                  <strong className="text-foreground">Trusted Partnerships:</strong> Long-standing collaborations with clients across speciality chemicals, bulk chemicals, dyes, and intermediates
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
